# -*- coding: utf-8 -*-
"""
Created on Fri Jul 21 09:49:09 2017
...
#import operator
import os
os.chdir("D:\Courses\MedIX_Project\Reproducableresults21Jul2017")
#import csv
...
#             tf_writer.writerow(",,"+content+"\n")
    ...
    x_train, x_test, tar_train, tar_test = cross_validation.train_test_split(his_tf.T,
    ...
    # print terms
    print("Cluster "+str(c)+" : ")
    print(list(his_tf.index[sig_feature_idx]))
...
def DTree_Calculate_Accr2(df, z):
    ...
    membership = fcluster(z, 50, criterion='maxclust')
    temp_his_tf = df.T
    temp_his_tf['Membership'] = membership.tolist()  
    return temp_his_tf, membership

ddf, membership = DTree_Calculate_Accr2(his_tf, Z)
...
BigClusterAnal(his_tf, tm4)
BigClusterAnal(his_tf, tm5)
...
for c in range(1,51):
    ...
    spec_tf = [True if x in subset_cluster.index else False for x in his_tf.columns]
